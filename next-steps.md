...
- Azure Container App to host the 'microsoft-gs-dps-host' service.
- Azure Container App to host the 'frontend-app' service.
- Azure Container App to host the 'service' service.
